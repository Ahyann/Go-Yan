export const translations = {
  id: {
    ...
    menungguDriverTerima: 'Menunggu driver menerima…',
    ahyanBelumBisa: 'Ahyan belum bisa sekarang!',
    driverBelumBisa: 'Driver belum bisa sekarang!',
    ...
    loginSubmit: 'Masuk',
    demoAtau: 'ATAU COBA DEMO',
    demoOjek: 'Demo sebagai Ojek',
    demoPenumpang: 'Demo sebagai Penumpang',
  ...
  en: {
    ...
    haloDemo: 'Hi, Demo Account',
    namaDemo: 'Demo Account',
    ...
    menungguDriverTerima: 'Waiting for driver to accept…',
    ahyanBelumBisa: "Ahyan can't right now!",
    driverBelumBisa: "Driver can't right now!",
    ahyanUdahTerima: 'Okay!',
    otwText: 'On My Way!',
    bubbleDefault: 'Otw dutzz!',
    ...
    loginSubmit: 'Sign in',
    demoAtau: 'OR TRY THE DEMO',
    demoOjek: 'Demo as Driver',
    demoPenumpang: 'Demo as Passenger',
